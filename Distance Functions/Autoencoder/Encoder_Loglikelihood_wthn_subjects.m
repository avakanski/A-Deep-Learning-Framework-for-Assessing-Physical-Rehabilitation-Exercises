% Encoder_Loglikelihood_wthn_subjects: uses autoencoder neural network to reduce the dimensionality of raw data, 
...
% Title: GMM Loglikelihood Within Subjects - Autoencoder Dimensionality Reduction
title('GMM Loglikelihood WS ENC','fontsize',18);
...
% print(h,'../../Results/GMM_Loglikelihood_WS_ENC','-dpng','-r300');
