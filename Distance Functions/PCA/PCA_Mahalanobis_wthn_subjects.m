% PCA_Mahalanobis_wthn_subjects: uses PCA to reduce the dimensionality of raw data, and 
...
% Title: Mahalanobis Distance Within Subjects - PCA Dimensionality Reduction
title('Mahalanobis Distance WS PCA','fontsize',18);
...
% print(h,'../../Results/Mahalanobis_Distance_WS_PCA','-dpng','-r300');
