% Var_DTW_wthn_subjects: uses maximum variance to reduce the dimensionality of raw data, and 
...
% Title: DTW Distance Within Subjects - Maximum Variance Dimensionality Reduction
title('DTW Distance WS MV','fontsize',18);
...
% print(h,'../../Results/DTW_Distance_WS_MV','-dpng','-r300');
