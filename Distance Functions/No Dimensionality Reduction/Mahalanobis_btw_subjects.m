% Mahalanobis_btw_subjects: calculates Mahalanobis distance on the raw data for the between-subject case
...
% Title: Mahalanobis Distance Between Subjects - No Dimensionality Reduction
title('Mahalanobis Distance BS NDR','fontsize',18);
...
% print(h,'../../Results/Mahalanobis_Distance_BS_NDR','-dpng','-r300');
